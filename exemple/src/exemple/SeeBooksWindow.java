 ...
 */
public class SeeBooksWindow extends javax.swing.JFrame {

    /**
     * Creates new form SeeBooksWindow
     */
    public SeeBooksWindow() {
        initComponents();
        this.init();
        this.initListe();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeeBooksWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeeBooksWindow().setVisible(true);
            }
        });
    }
